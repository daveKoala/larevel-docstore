...
@section('content')
<div class="max-w-2xl">
    <form action="{{ route('dashboard.orders.update', $order) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="details"
                              ...
                              rows="6"
                              required
                              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">{{ old('details', $order->details) }}</textarea>
                ...
                <div class="pt-5 border-t border-gray-200">
                    <dl class="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 font-mono">{{ substr($order->guid, 0, 16) }}...</dd>
                        </div>
                        <div class="sm:col-span-1">
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <dd class="mt-1 text-sm text-gray-900">{{ $order->updated_at->format('M d, Y') }}</dd>
                        </div>
                    </dl>
                </div>
            </div>
