                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <select name="organization_id"
                                    id="organization_id"
                                    required
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('organization_id') border-red-300 @enderror">
                        ...
                        <div class="pt-5 border-t border-gray-200">
                            <dl class="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900 font-mono">{{ $project->guid }}</dd>
                                </div>
                                <div class="sm:col-span-1">
                                ...
                                <div class="sm:col-span-1">
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">{{ $project->updated_at->format('M d, Y') }}</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
